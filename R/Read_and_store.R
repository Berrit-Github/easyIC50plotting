...
Read_and_store <- function(pathname_of_file , file_type){
  ...
  } else if (file_type == ".csv"){onderzoek_data_portfolie_1 <- utils::read_csv(pathname_of_file)
  } else if (file_type == ".csv2"){onderzoek_data_portfolie_1 <- utils::read_csv2(pathname_of_file)
